...
def on_delete(req, resp, user_name, team_name):
    ...
    **Example request:**
    ...
    """
    # Use user_name directly in check_user_auth as it's a URL parameter
    ...
    with db.connect() as connection:
        ...
        try:
            ...
            cursor.execute(
                ...
                (user_name, team_name),  # Parameterize user_name and team_name
            )
            ...
            print(
                f"Error during pinned team deletion for user={user_name}, team={team_name}: {e}"
