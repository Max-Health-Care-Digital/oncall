...
assets_env.register(
    "oncall_css",
    Bundle("css/oncall.css", "css/incalendar.css", output="bundles/oncall.css"),
)
assets_env.register(
    "loginsplash_css",
    Bundle("css/loginsplash.css", output="bundles/loginsplash.css"),
)
assets_env.register(
    "loginsplash_js",
    Bundle("js/loginsplash.js", output="bundles/loginsplash.bundle.js"),
)
...
INDEX_CONTENT_SETTING = {
    "user_setting_note": "",
    "footer": '<ul><li>Oncall © LinkedIn %s</li><li><a href="http://oncall.tools" target="_blank">About</a></li></ul>'
    % date.today().year,
}
...
def init(application, config):
    ...
    PUBLIC_CALENDAR_ADDITIONAL_MESSAGE = config.get(
    ...
    application.add_route(
        "/static/bundles/{filename}", StaticResource("/static/bundles")
    )
    application.add_route(
        "/static/images/{filename}", StaticResource("/static/images")
    )
    application.add_route(
        "/static/fonts/{filename}", StaticResource("/static/fonts")
    )
